...
echo "copyCnf c1.cnf xort.cnf.end c1$cnt.cnf.tmp" 1>&2
./copyCnf c1.cnf xort.cnf.end c1$cnt.cnf.tmp
...
./copyInfo c1.keyInfo xort.cnf.end c1$cnt.keyInfo
...
do
    ...
    echo "copyCnf c1.cnf xxort2$pre.cnf.end c1$cnt.cnf.tmp" 1>&2
    ../exp/copyCnf c1.cnf xxort2$pre.cnf.end c1$cnt.cnf.tmp
    ...
    ./copyInfo c1.keyInfo xxort2$pre.cnf.end c1$cnt.keyInfo
    ...
    echo "cat f$pre.cnf c1$pre.cnf c2$pre.cnf brC1C1$pre.cnf brC2C2$pre.cnf xxort1$pre.cnf xxort2$pre.cnf.end > f$cnt.cnf" 1>&2
    cat f$pre.cnf c1$pre.cnf c2$pre.cnf brC1C1$pre.cnf brC2C2$pre.cnf xxort1$pre.cnf xxort2$pre.cnf> f$cnt.cnf
